        ...
        <div class="UpHeaderAU">
            <div class="LogoAU">
                <a class="LogoTextAU" href="index.php">Trinty 
                    <a class="LogoText SmallAU" href="index.php">ЗАГРУЗКА</a>
                </a>
            </div>
            ...
            <div class='UserNameUpload'>
                ...
                <div class='uploadImages'>
                    <div class="mainImageUpload">
                        <div class="field__file-button">Главное изображение</div>
                    </div>
                    <div class="uploadDopImages">
                        <div class="buttonUploadImages">
                            ...
                            <label for="file2" class='dopImagesUploadWrapper'>
                                <div class="dopImagesUploadText">Загрузить изображение</div>
                            </label>
                            <span class="descripUploadTx">(Не больше 8 изо.)</span>
                        </div>
                        <div class="dopPhoto">
                ...
                <div class="placeRash">
                    <span class="textRash">Доступные расширения:</span>
                    ...
                    <label for="file3" class='fileUploadWrapper'>
                        <div class="fileUploadText">Загрузить файл</div>
                    </label>
                    <span class="descripFileUploadTx">(Не больше 200M)</span>
                </div>
        ...
        $(document).ready(function(e){ 
            $('.field__file-button').on({
                mouseenter: function() {
                    ...
                    $('.field__file-button').contents()[0].nodeValue = 'Выберете из загруженных изображений';
                },
                mouseleave: function() {
                    $('.field__file-button').css('background-color',"#4c4cb3");
                    $('.field__file-button').contents()[0].nodeValue = 'Главное изображение';
                },
            });
